...
vendasApp.factory('Constants',function(){
	return {
		...
		URL_UPLOAD_PRODUCT : 'http://localhost/vendas-api/v1/upload/uploadProductPicture',
		URL_UPLOAD_CUSTOMER : 'http://localhost/vendas-api/v1/upload/uploadCustomerPicture',
		URL_UPLOAD_USER : 'http://localhost/vendas-api/v1/upload/uploadUserPicture',
