...
public class GoalServiceImpl implements GoalService {
	...
	@Override
	public ServiceResponse<List<Goal>> findAllByChangeGreaterThan(Long date, Integer organizationID, Integer offset) {
		return ServiceResponseFactory.create(targetsDAO.findAllByChangeGreaterThan(new Date(date), organizationID, offset, LimitQuery.LIMIT_SYNC_INIT_LOAD.value()));
	}
